// PM-KR CG submission — generated via cue export.
//
// Usage:
//   cue export ./w3c/ -e pm_kr_report --out text > w3c/pm-kr.md
package w3c
...
pm_kr_report: """
	...
	**Use Case Submission for the PM-KR Community Group**
	...
	\(evidence.cpm_summary.critical_count)-node critical path,
	\(evidence.cpm_summary.total_duration)-day total duration,
	maximum slack \(evidence.cpm_summary.max_slack) days. This is standard CPM
