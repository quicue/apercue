...
core_report: """
	...
	**Use Case Report for W3C Community Groups**
	...
	A single typed dependency graph produces \(evidence.spec_counts.total)
	...
	\(evidence.spec_counts.implemented) specs implemented,
	\(evidence.spec_counts.downstream) downstream,
	\(evidence.spec_counts.total) total. Adding a projection is adding
